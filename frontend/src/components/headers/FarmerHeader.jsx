...
const FarmerHeader = ({ onLogout, activeTab, onTabChange, user }) => {
  ...
  const tabs = [
    ...
    { id: 'products', label: 'My Harvest', icon: Package },
      ...
      <div className="container mx-auto px-4 lg:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-lime-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-emerald-100">
            ...
            <div className="hidden md:block">
              ...
              <span className="text-xs block text-slate-400 font-medium -mt-1 uppercase tracking-wider">Farmer Portal</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-3 pl-4 border-l border-slate-100">
              <div className="text-right">
                <p className="text-sm font-bold text-slate-700">{user?.firstName || 'Farmer'}</p>
                <p className="text-xs text-slate-400 font-medium">{user?.farmName || 'My Farm'}</p>
              </div>
              <button 
                onClick={onLogout}
      ...
      {showMobileMenu && (
        <div className="md:hidden border-t border-slate-100 bg-white">
          <div className="p-4 space-y-2">
            <div className="flex items-center gap-3 mb-6 p-3 bg-emerald-50 rounded-xl">
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center space-x-3 w-full p-3 rounded-xl font-medium transition-colors ${
                  activeTab === tab.id
